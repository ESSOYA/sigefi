...
export default function ComparateurIA() {
  ...
  return (
    <DashboardLayout>
      ...
      <div>
      <h1 className="text-2xl font-bold mb-4">Comparateur IA</h1>
      <Card className="p-6">
        <p>Ceci est une page de démonstration pour le comparateur IA. Ici vous verrez le score de conformité et les flags générés par l'outil d'intelligence artificielle.</p>
      </Card>
    </div>
